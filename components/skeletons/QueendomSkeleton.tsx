        ...
        <div className="relative z-10 flex min-h-0 flex-1 flex-col gap-[var(--gap-card)]">
          ...
          <div className="flex items-center gap-3 sm:gap-4 px-2 border-b border-gold-500/20 pb-[0.9vh]">
            ...
            {["flex-[2]", "flex-1", "flex-1", "flex-1"].map((cls, i) => (
              <Sk
                key={i}
                className={`${cls} rounded-lg h-[clamp(14px,1.8vh,22px)]`}
          ...
          <div className="flex min-h-0 w-full flex-col md:flex-row md:items-start md:gap-[var(--gap-section)]">
            ...
            <div className="min-h-0 min-w-0 w-full flex-shrink-0 md:flex-1">
              {[0, 0.12, 0.24, 0.36].map((delay, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 sm:gap-4 px-2 py-[1vh]"
                >
                  <Sk
                  ...
                  />
                  <Sk
                    className="flex-[2] rounded-lg h-[clamp(18px,2vh,28px)]"
            ...
            >
              <Sk
                ...
                style={{ width: "60%", height: "clamp(18px,2.2vh,28px)" }}
              />
