...
export default function TopBar() {
  ...
  return (
    ...
    >
      ...
      {/* ── Date (left) ── */}
      <p className="font-inter text-[18px] tracking-[0.35em] uppercase text-gold-500 tabular-nums">
        {dateStr}
      </p>

      {/* ── Central Branding ── */}
      <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center select-none">
        <h1 className="font-playfair text-[2.6rem] tracking-[0.38em] text-gold-400 gold-glow uppercase leading-none">
          Indulge Global
        </h1>
        <div className="flex items-center gap-3 mt-[6px]">
          <div className="h-px w-16 bg-gradient-to-r from-transparent to-gold-500/50" />
          <span className="font-inter text-[13px] tracking-[0.55em] uppercase text-gold-500/40">
            Live Operations
          </span>
      ...
      <div className="flex items-center gap-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-inter text-[14px] tracking-[0.35em] uppercase text-emerald-400/75">
            Live
          </span>
        </div>

        <p className="font-inter text-[20px] tracking-[0.35em] text-gold-400 tabular-nums">
          {timeStr}
        </p>
      </div>
    </motion.header>
